...
#conv1 :神经元图，feature_map,输出图像 卷积层
conv1_1=tf.layers.conv2d(x_image,
                        32,#卷积核输出的通道数目
                        (3,3),#卷积核大小
                        padding='same',#输出的图像大小不做变化，还有一个是valid表示不做padding,减少到多少就是多少
                        activation=tf.nn.relu,
                        name='conv1_1'#给这一层做一个命名
...
y_=tf.layers.dense(flatten,10)#dense,全连接的封装,10表示中间层
